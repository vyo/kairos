...
public class Translator {
	 ...
	 * 
	 * @param s
	 *            A string representing a number in decimal
	 ...
	 * 
	 * @param s
	 *            A string consisting of 0s and 1s representing char encodings
	 ...
	 * 
	 * @param s
	 *            A string consisting of 0s and 1s.
	 ...
	 * 
	 * @param s
	 *            A string consisting of spaces and tabs.
